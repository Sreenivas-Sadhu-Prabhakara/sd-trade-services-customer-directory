package com.bank.bian.tradeservicescustomerdirectory.model;
...
/**
 * The BIAN control record for this service domain: "Trade Counterparty Directory Entry".
 *
 ...
 * to its asset type (Trade Counterparty). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Trade Counterparty Directory Entry";
